				  ...
				  <div class="test">
					...
					<form action="" method="post" name="frm" id="frm">
					  <table width="100%"  border="0" cellspacing="0" cellpadding="7">
						...
						<tr>
						  <td>
						  	  <label for="ano">Digite o mês:</label>
							  <input name="mes" type="text" id="mes" size="9" maxlength="15" class="required" placeholder="00" value="<?php echo $mes ?>"/>
							</td>
						</tr>
					  </table>
					  <p align="center">
						<input name="adicionar" type="submit" id="first" value="Visualizar Relatório" onClick="document.frm.action='atendimentos_relatorio_mensal2.php'"/>
					  </p>
					</form>
					<p>&nbsp;</p>
				  </div>
