...
if (isset($_POST['adicionar'])) {
		$db->query("UPDATE tb_produtos SET nome='$nome' WHERE produto_id=$produto_id");
					 ...
					 <table width="100%" border="0" cellpadding="5" cellspacing="0">
					  ...
					  <tr>
						 <td><table width="100%" border="0" cellspacing="0" cellpadding="10">
							 <tr>
							  <td><form id="form2" name="form2" method="post" action="produtos_editar.php">
								  <fieldset>
									<legend style="border:none">Selecione o Produto</legend>
									<select name="produto_id" id="produto_id" >
									  <?php
										$secoes = $db->get_results("SELECT produto_id, nome FROM tb_produtos ORDER BY nome");
										foreach($secoes as $secoes) {
								  ?>
									  <option value="<?php echo '-'.$secoes->produto_id ?>" "><?php echo $secoes->nome ?></option>
									  <?php } ?>
									</select>
									&nbsp;&nbsp;
								 ...
								 <?php  
									if(isset($produto_id)) {
									$lista = $db->get_row("SELECT *  FROM tb_produtos WHERE produto_id=$produto_id"); 
								?>
								 <br />
								 <br />
								 <div class="box4">
								  <form action="" method="post" name="form1" id="form1" style="display: inline; margin: 0;">
									 <table width="100%" cellpadding="4" cellspacing="0">
									  <tr>
										 <td width="12%">Nome do produto:</td>
									 ...
									 <p align="center">
									  ...
									  <input name="adicionar" type="submit" id="adicionar" value="Editar Produto" />
									</p>
									 <p>
									  <?php  } ?>
									</p>
