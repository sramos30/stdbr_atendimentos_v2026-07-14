...
class XLSXWriter
{
	...
	public function downloadFile( $filename, $userfname ) {
	...
	public static function xmlspecialchars($val)
	{
		...
		static $goodchars = "                              ";
		return !empty($val) ? strtr(htmlspecialchars($val, ENT_QUOTES | ENT_XML1), $badchars, $goodchars) : "";//strtr appears to be faster than str_replace
	}
	//------------------------------------------------------------------
