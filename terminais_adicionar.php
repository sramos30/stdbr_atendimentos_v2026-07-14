...
if (isset($_POST['adicionar'])) {
		$db->query("INSERT INTO tb_terminais (nome) VALUES ('$nome')");		
		$msg = "Terminal adicionado com sucesso!";
		}
?>
					...
					<table width="100%" border="0" cellpadding="5" cellspacing="0">
					  <tr>
						<td height="21" background="imagens/back_tit.jpg" style="height:21px"><span class="style1">Adicionar
							  Terminal
						  <?php if (isset($msg)) echo "<script language=\"JavaScript\"> window.alert(\"$msg\");window.location='terminais_adicionar.php';</script>" ?>
						</span></td>
					  </tr>
					  <tr>
						<td><div class="box4">
						  <form action="" method="post" name="Terminal" id="Terminal" style="display: inline; margin: 0;">
							...
							<p align="center">
							  <input name="adicionar" type="submit" id="adicionar" value="Adicionar Terminal" />
							</p>
						  </form>
						</div>
						</td>
