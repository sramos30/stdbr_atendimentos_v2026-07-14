...
if (isset($_POST['adicionar'])) {
		$db->query("INSERT INTO tb_produtos (nome) VALUES ('$nome')");		
					...
					<table width="100%" border="0" cellpadding="5" cellspacing="0">
					  <tr>
						<td height="21" background="imagens/back_tit.jpg" style="height:21px"><span class="style1">Adicionar
							  Produto
						  <?php if (isset($msg)) echo "<script language=\"JavaScript\"> window.alert(\"$msg\");window.location='produtos_editar.php';</script>" ?>
						</span></td>
					  </tr>
					  <tr>
						<td><div class="box4">
						  <form action="" method="post" name="Produto" id="Produto" style="display: inline; margin: 0;">
							...
							<p align="center">
							  <input name="adicionar" type="submit" id="adicionar" value="Adicionar Produto" />
							</p>
						  </form>
						</div>
						</td>
